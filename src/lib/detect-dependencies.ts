...
const SCRIPT_RULES: ScriptRule[] = [
  // Animation
  {
    pattern: /gsap(?:\.min)?\.js|cdnjs.*gsap|TweenMax|TweenLite|@gsap\//i,
    pkg: "gsap",
    version: "^3.12.0",
  },
  ...
  {
    pattern: /scrollreveal(?:\.min)?\.js/i,
    pkg: "scrollreveal",
    version: "^4.0.9",
  },
  {
    pattern: /lenis(?:\.min)?\.js|@studio-freight\/lenis/i,
    pkg: "lenis",
    version: "^1.1.0",
  },
  {
    pattern: /locomotive-scroll/i,
    pkg: "locomotive-scroll",
    version: "^4.1.4",
  },
  { pattern: /splitting(?:\.min)?\.js/i, pkg: "splitting", version: "^1.0.6" },
  {
    pattern: /ScrollMagic(?:\.min)?\.js/i,
    pkg: "scrollmagic",
    version: "^2.0.8",
  },
  {
    pattern: /anime(?:\.min)?\.js|animejs/i,
    pkg: "animejs",
    version: "^3.2.2",
  },
  {
    pattern: /motion(?:\.min)?\.js|@motionone\/dom/i,
    pkg: "motion",
    version: "^10.18.0",
  },
  {
    pattern: /barba(?:\.min)?\.js|@barba\/core/i,
    pkg: "@barba/core",
    version: "^2.9.7",
  },
  {
    pattern: /velocity(?:\.min)?\.js/i,
    pkg: "velocity-animate",
    version: "^2.0.6",
  },
  // UI / sliders
  {
    pattern: /swiper(?:\.min)?\.js|swiperjs/i,
    pkg: "swiper",
    version: "^11.0.0",
  },
  {
    pattern: /embla-carousel(?!-react)/i,
    pkg: "embla-carousel",
    version: "^8.0.0",
  },
  { pattern: /keen-slider/i, pkg: "keen-slider", version: "^6.8.6" },
  {
    pattern: /glide(?:\.min)?\.js|@glidejs\//i,
    pkg: "@glidejs/glide",
    version: "^3.7.2",
  },
  {
    pattern: /slick(?:\.min)?\.js|slick-carousel/i,
    pkg: "slick-carousel",
    version: "^1.8.1",
  },
  {
    pattern: /isotope(?:\.min)?\.js/i,
    pkg: "isotope-layout",
    version: "^3.0.6",
  },
  {
    pattern: /masonry(?:\.min)?\.js/i,
    pkg: "masonry-layout",
    version: "^4.2.2",
  },
  // Lightbox / media
  ...
  // Lottie
  {
    pattern: /lottie(?:-web|-player|\.min)?\.js/i,
    pkg: "lottie-web",
    version: "^5.12.0",
  },
  // Typed / text
  ...
  {
    pattern: /typewriter-effect/i,
    pkg: "typewriter-effect",
    version: "^2.21.0",
  },
  // Particles
  {
    pattern: /particles(?:\.min)?\.js|tsparticles/i,
    pkg: "tsparticles",
    version: "^3.0.0",
  },
  // 3D / canvas
  {
    pattern: /three(?:\.min)?\.js|three\/build\//i,
    pkg: "three",
    version: "^0.169.0",
  },
  ...
  // Chart
  {
    pattern: /chart(?:\.min)?\.js|chartjs/i,
    pkg: "chart.js",
    version: "^4.4.0",
  },
  ...
  // Misc
  {
    pattern: /\bimagesloaded(?:\.min)?\.js/i,
    pkg: "imagesloaded",
    version: "^5.0.0",
  },
...
const CSS_LINK_RULES: CssLinkRule[] = [
  ...
  {
    pattern: /flatpickr(?:\.min)?\.css/i,
    pkg: "flatpickr",
    version: "^4.6.13",
  },
  {
    pattern: /nouislider(?:\.min)?\.css/i,
    pkg: "nouislider",
    version: "^15.8.0",
  },
...
const INLINE_JS_RULES: ScriptRule[] = [
  {
    pattern: /\bgsap\s*\.\s*(?:to|from|fromTo|timeline|registerPlugin)/i,
    pkg: "gsap",
    version: "^3.12.0",
  },
  ...
  {
    pattern: /\bScrollReveal\s*\(\s*\)/i,
    pkg: "scrollreveal",
    version: "^4.0.9",
  },
  { pattern: /new\s+Lenis\s*\(/i, pkg: "lenis", version: "^1.1.0" },
  {
    pattern: /new\s+LocomotiveScroll\s*\(/i,
    pkg: "locomotive-scroll",
    version: "^4.1.4",
  },
  {
    pattern: /\bLottie\s*\.\s*(?:loadAnimation|create)/i,
    pkg: "lottie-web",
    version: "^5.12.0",
  },
  ...
  {
    pattern: /\btsParticles\b|\bparticlesJS\s*\(/i,
    pkg: "tsparticles",
    version: "^3.0.0",
  },
  {
    pattern: /new\s+THREE\b|THREE\s*\.\s*(?:Scene|Camera|Renderer)/i,
    pkg: "three",
    version: "^0.169.0",
  },
  { pattern: /new\s+Chart\s*\(/i, pkg: "chart.js", version: "^4.4.0" },
  {
    pattern: /\bd3\s*\.\s*(?:select|scaleLinear|line\s*\()/i,
    pkg: "d3",
    version: "^7.9.0",
  },
  ...
  {
    pattern:
      /\$\s*\(\s*['"][^'"]*['"]\s*\)\s*\.(?:slick|owlCarousel|magnificPopup)/i,
    pkg: "jquery",
    version: "^3.7.1",
  },
  {
    pattern: /\bBarba\s*\.\s*init\s*\(/i,
    pkg: "@barba/core",
    version: "^2.9.7",
  },
  {
    pattern: /new\s+ScrollMagic\s*\.\s*Controller/i,
    pkg: "scrollmagic",
    version: "^2.0.8",
  },
  ...
  { pattern: /ApexCharts/i, pkg: "apexcharts", version: "^3.53.0" },
  {
    pattern: /\bemblaApi\b|EmblaCarousel\s*\(/i,
    pkg: "embla-carousel",
    version: "^8.0.0",
  },
...
const CSS_RULES: Array<{ pattern: RegExp; pkg: string; version: string }> = [
  {
    pattern: /--tw-(?:ring|shadow|blur|translate|rotate|scale|skew)\b/,
    pkg: "tailwindcss",
    version: "^3.4.0",
  },
  { pattern: /\[data-aos\]/, pkg: "aos", version: "^2.3.4" },
  {
    pattern: /\.swiper-(?:wrapper|slide|container)\b/,
    pkg: "swiper",
    version: "^11.0.0",
  },
  {
    pattern: /\.glide(?:__track|__slides|__slide)\b/,
    pkg: "@glidejs/glide",
    version: "^3.7.2",
  },
  {
    pattern: /\.lottie-(?:player|container)\b/,
    pkg: "lottie-web",
    version: "^5.12.0",
  },
  {
    pattern: /\.splitting\b|\.word\b\s*>\s*\.char\b/,
    pkg: "splitting",
    version: "^1.0.6",
  },
...
const PLATFORM_DEPS: Record<
  string,
  Array<{ pkg: string; version: string; dev?: boolean; note: string }>
> = {
  Framer: [
    {
      pkg: "framer-motion",
      version: "^11.0.0",
      note: "Framer site detected - framer-motion for React animations",
    },
  ],
  Webflow: [
    {
      pkg: "gsap",
      version: "^3.12.0",
      note: "Webflow often uses GSAP for interactions",
    },
  ],
};
...
export function detectNpmDependencies(
  ...
  for (const rule of INLINE_JS_RULES) {
    if (rule.pattern.test(inlineJsText))
  ...
  if (!seen.has("tailwindcss")) {
    const twClassPattern =
      /class=["'][^"']*\b(?:flex|grid|items-center|justify-between|px-\d|py-\d|text-\w+-\d{3}|bg-\w+-\d{3}|rounded-\w+|shadow-\w+|gap-\d)\b[^"']*/g;
    ...
    if (twMatches >= 5 || /cdn\.tailwindcss\.com/i.test(allHtml)) {
      ...
      notes.push(
        "Tailwind CSS detected - run `npx tailwindcss init -p` to configure.",
      );
    }
  }
  ...
  if (!seen.has("bootstrap")) {
    const bsClassPattern =
      /\b(?:btn btn-|col-(?:sm|md|lg|xl)-\d|navbar-(?:brand|toggler|collapse)|modal-(?:dialog|content|header)|card-(?:body|header|footer))\b/;
  ...
  if (seen.has("aos")) {
    notes.push(
      'AOS detected - add `import "aos/dist/aos.css"` and call `AOS.init()` in your entry file.',
    );
  }
  if (seen.has("swiper")) {
  ...
  if (seen.has("lenis")) {
    notes.push(
      "Lenis smooth scroll detected - initialize with `new Lenis()` and hook into your RAF loop.",
    );
  }
  if (seen.has("gsap") && /ScrollTrigger/i.test(allHtml + inlineJsText)) {
    notes.push(
      "GSAP ScrollTrigger detected - register with `gsap.registerPlugin(ScrollTrigger)` before use.",
    );
  }
